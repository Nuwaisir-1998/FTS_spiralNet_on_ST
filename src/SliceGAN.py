    ...
    def train(self):
        ...
        while (keep_training):
            ...
            for it in train_loader:
                ...
                # print('fmask_data.shape:', fmask_data.shape)
                if self.config.CATMASK:
                ...
                if self.config.DATATYPE == 1:
                    ...
                    pos = pos[0]
                    position = (pos, (pos[0] + 64, pos[1] + 64))
                ...
                sf_data = up(sf_data)
                # print('sf_data.shape', sf_data.shape)
                ...
                print('printing:')
                print(f'ite: {ite}, max_iter: {max_iter}')
